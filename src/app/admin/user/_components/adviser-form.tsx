              ...
              <div className="w-full">
                <Select
                  ...
                  onValueChange={(value) =>
                    setFormData((prev) => ({
                      ...prev,
                      schoolYear: value as SchoolYearTypes,
                    }))
                  }
                >
                ...
                {errors.schoolYear && (
                  <p className="text-xs text-red-600">{errors.schoolYear}</p>
                )}
              </div>
            </div>
          </CardContent>
        ...
        <Card className="">
          <CardContent className="space-y-3">
            <div className="flex items-center gap-x-3 w-full">
              ...
              <Label className="">
                {formData.schoolYear ?? "Not selected"}{" "}
              </Label>
            </div>
            <div className="flex items-center gap-x-3 w-full">
              <Label htmlFor="" className="n text-nowrap">
                Grade Level:
              </Label>
              <div className="w-full">
                <Select
                  ...
                  onValueChange={(value) =>
                    setFormData((prev) => ({
                      ...prev,
                      gradeLevel: value as GradeLevelsTypes,
                    }))
                  }
                >
            ...
            <Label htmlFor="sectionName" className="underline text-xl">
              Add Section
            </Label>
            <div className="w-3/4 mx-auto">
              <div className="flex items-center gap-x-3 w-full ">
                ...
                <div className="w-full">
                  ...
                  />
                  {errors.sectionName && (
                    <p className="text-xs normal-case text-red-600">
                      {errors.sectionName}
                    </p>
                  )}
                </div>
