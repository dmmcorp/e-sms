    ...
    <div>
        <Tabs defaultValue={"class-record"} className="w-full relative  space-y-5  shadow-none">
          ...
          <TabsList className='w-fit md:block'> 
            ...
            <TabsTrigger value="grades-summary" className='font-medium text-[0.5rem] md:text-sm  shadow-md border-b-2 data-[state=active]:border-b-primary data-[state=active]:text-primary'>Grades Summary</TabsTrigger>
