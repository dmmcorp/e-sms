    ...
    toast.promise(
      addStudent({
        ...
        juniorHighDateOfAdmission:
          values.jnrDateOfAdmission?.toDateString() || undefined,
        alsRating: values.alsRating,
        enrollingIn: values.enrollingTo as GradeLevelsTypes,
        semesterEnrollingIn: values.semesterEnrollingIn as
          | "1st semester"
          | "2nd semester"
          | undefined,
      }),
      ...
      <Card className="w-full">
        ...
        <CardContent className="pt-6">
          <p className="text-muted-foreground mb-6">
            Thank you for submitting your enrollment form. Your application has
            been received and is being processed. You will receive a
        ...
        <CardHeader className="bg-slate-50 border-b">
          <div className="flex items-center justify-between">
            <div>
              ...
              <CardDescription>
                Please fill out all required information to complete the adding
                student process
              </CardDescription>
            </div>
                ...
                <>
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
                    ...
                    <div className="space-y-6">
                      ...
                      <FormField
                        ...
                        render={({ field }) => (
                          <FormItem>
                            <FormLabel>General Average</FormLabel>
                            <FormControl>
                              <Input
                                type="number"
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        ...
                        <FormDescription>
                          Alternative Learning System rating (if applicable)
                        </FormDescription>
                        <FormMessage />
                      </FormItem>
                    )}
                  ...
                  <div className="bg-amber-50 p-4 rounded-lg border border-amber-200">
                    ...
                    <p className="text-amber-700 text-sm">
                      Please review all information carefully. By submitting
