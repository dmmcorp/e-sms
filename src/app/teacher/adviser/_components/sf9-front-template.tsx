...
function SF9FrontTemplate({ student, readOnly }: SF9FrontTemplateProps) {
    ...
    return (
        <div className='grid grid-cols-2 gap-x-10 p-9 text-black  w-full border-2 rounded-2xl'>
            <div className={cn(isSHS ? "py-10" : "py-0")}>
                <div onClick={() => setAttendanceDialog(true)} className={cn(readOnly ? "hover:cursor-default" : "hover:cursor-pointer")}>
